             ...
             var flag=false;
	       	...
	       	$('#company_name').blur(function(){     
		       		$('#company_name').next().css({"display":"none"});
		       		 ...
		       		 if(!(companyName.trim() == '')){
		       			...
		       			$('#company_name').next().addClass('error').text("Please enter company name").fadeIn();
		       			com_judgment = false; 
		       		 }		       		 
		       		 return false;
		       	 });
	       	...
	       	$('#user_name').blur(function(){     
	       		...
	       		if(!(userName.trim() == '')){
	       			...
	       			$('#user_name').next().addClass('error').text("Please enter user name").fadeIn();
	       			user_judgment = false; 
	       		}		       		 
	       		return false;
	       	});
	       	 ...
	       	 $('#pwd').blur(function(){     
	       		$('#pwd').next().css({"display":"none"});
	       		 ...
	       		 var psdReg = /^[0-9a-zA-Z_]{6,15}$/;//密码正则
	       			if (!psdReg.test(pwd)) {
	       				$('#pwd').next().addClass('error').text("6-15 digits or letters").fadeIn();
	       			    p_judgment = false;
	       				return false;
	       			} 
		        ...
		        var pwd = $('#pwd').val();
	       		...
	       		if (pwd != pwd1) {
	       			    $('#pwd1').next().addClass('error').text("Passwords must match").fadeIn();
	       			    dp_judgment = false;
	       				return false;
	       			} 
	       		...
	       		var psdReg = /^[0-9a-zA-Z_]{6,15}$/;//密码正则
   			if (!psdReg.test(pwd1)) {
   				$('#pwd1').next().addClass('error').text("6-15 digits or letters").fadeIn();
   			    p_judgment = false;
   				return false;
   			} 	 
	            ...
	            $('#email').blur(function(){
	             $('#email').next().css({"display":"none"});
	           	 ...
	           	 if(email == null || email == ''){
	           		 ...
	           		 $('#email').next().text("E-mail can not be empty").fadeIn();
	           		 e_judgment = false;
	           		 return false;
	           	 }
	   	       	   //验证邮箱是否合法
	   	    	   ...
	   	    	   if(!(email == null || email.length==0)){
	   	   			...
	   	   			if(!bChk){
	   	   			    $('#email').next().addClass('error'); 
	           		    $('#email').next().text("E-mail format is incorrect").fadeIn();
	   	   				e_judgment = false;
	   	   				return false;
	   	   			}
	   	   		   }         	 	           	 
      	        	   ...
      	        	   function(result){
      	        	     if(result.state == 0){
	     	                ...
	     	                e_judgment = true;
	      	      	    	 ...
	      	      	    	 $('#email').next().addClass('error');
	     			    	 $('#email').next().text("Email already exists").fadeIn();
	     			    	 e_judgment = false;
      	        	     }
      	        	  }); 
	             })     
...
//	             }) 
	       	...
	       	$('#buyer_companyName').blur(function(){     
		       		$('#buyer_companyName').next().css({"display":"none"});
		       		 ...
		       		 if(!(companyName.trim() == '')){
		       			...
		       			$('#buyer_companyName').next().addClass('error').text("Please enter company name").fadeIn();
		       			com_judgment = false; 
		       		 }		       		 
		       		 return false;
		       	 });
	       	...
	       	$('#buyer_name').blur(function(){     
	       		...
	       		if(!(userName.trim() == '')){
	       			...
	       			$('#buyer_name').next().addClass('error').text("Please enter user name").fadeIn();
	       			user_judgment = false; 
	       		}		       		 
	       		return false;
	       	});
	       	 ...
	       	 $('#buyer_password').blur(function(){     
	       		$('#buyer_password').next().css({"display":"none"});
	       		 ...
	       		 var psdReg = /^[0-9a-zA-Z_]{6,15}$/;//密码正则
	       			if (!psdReg.test(pwd)) {
	       				$('#buyer_password').next().addClass('error').text("6-15 digits or letters").fadeIn();
	       			    p_judgment = false;
	       				return false;
	       			} 
		        ...
		        var pwd = $('#buyer_password').val();
	       		...
	       		if (pwd != pwd1) {
	       			    $('#rePassword').next().addClass('error').text("Passwords must match").fadeIn();
	       			    dp_judgment = false;
	       				return false;
	       			} 
	       		...
	       		var psdReg = /^[0-9a-zA-Z_]{6,15}$/;//密码正则
   			if (!psdReg.test(pwd1)) {
   				$('#rePassword').next().addClass('error').text("6-15 digits or letters").fadeIn();
   			    p_judgment = false;
   				return false;
   			} 	 
	            ...
	            */
	            $('#buyer_email').blur(function(){
	             $('#buyer_email').next().css({"display":"none"});
	           	 ...
	           	 if(email == null || email == ''){
	           		 ...
	           		 $('#buyer_email').next().text("E-mail can not be empty").fadeIn();
	           		 e_judgment = false;
	           		 return false;
	           	 }
	   	       	   //验证邮箱是否合法
	   	    	   ...
	   	    	   if(!(email == null || email.length==0)){
	   	   			...
	   	   			if(!bChk){
	   	   			    $('#buyer_email').next().addClass('error'); 
	           		    $('#buyer_email').next().text("E-mail format is incorrect").fadeIn();
	   	   				e_judgment = false;
	   	   				return false;
	   	   			}
	   	   		   }         	 	           	 
      	        	   ...
      	        	   function(result){
      	        	     if(result.state == 0){
	     	                ...
	     	                e_judgment = true;
	      	      	    	 ...
	      	      	    	 $('#buyer_email').next().addClass('error');
	     			    	 $('#buyer_email').next().text("Email already exists").fadeIn();
	     			    	 e_judgment = false;
      	        	     }
      	        	  }); 
	             })
				...
				$('.register_en .next_1').click(function(){
                    ...
                    // $('#rePassword').blur();
                    $('#buyer_name').blur();
                    if(!(e_judgment && com_judgment && user_judgment)){
                        return false;
                    }

                    $('.register_en .forms_in').stop().animate({'left':'-658px'},500);
				})
	    				...
	    				data : {
	    				  ...
	    				  "pwd":"111111",
 					      ...
 					      "mobilePhone" : $('#mobile_phone').val(),
	  					  ...
	  					  "url" : url,
	  					  "companyIntroduction" : $('#company_introduction').val(),
	  					  "factoryType" : factoryType 
	    				},
	    				success : function(data) {
	    				  	$('#sub_btn1').css({'background-color':'#006dcc'}).removeAttr('disabled');
	    					if(data.state==0){
	    						window.location = "/en/prodect_registered_login.html"
	    					}
           ...
           function login(){
        	    ...
        	    if(loginEmail == null || loginEmail == '' || loginEmail == undefined){
        	    	easyDialog.open({
			    		  container : {
			    		    header : 'Prompt message',
			    		    content : 'E-mail can not be empty'
			    		  },
			    		  overlay : false,
			    		  autoClose : 1000   			    		  
			    		});
