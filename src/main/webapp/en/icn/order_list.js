...
//查询正常询盘
 function queryOrder(status,page){
	...
	if(process == undefined || process.trim() == "Process"){
	   process = "";
	}else{
		var index = getProcessIndex(process);
		process = getProcessByIndex(index);
	}
			    	  ...
			    	  for(var i=0;i<tl;i++){
			    		...
			    		//获取国家对标国旗
			    		  ...
			    		  var tr =   '<tr>'+
					                      ...
					                      '<span class="amt10" title="'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'">'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'</span>'+
					                  '</td>'+
					                  '<td class="d2">'+
		    		  ...
		    		  if(injectionOrders != null && injectionOrders != '' && injectionOrders != undefined){
		    			  ...
		    			  for(var i=0;i<injectionOrders.length;i++){
		    				  ...
		    				  var tr = '<tr>'+
			        						...
			        						'</div>'+
			        						'<span class="amt10" title="'+(injectionOrders[i].quoteTitle == null ? injectionOrders[i].productName : injectionOrders[i].quoteTitle)+'">'+(injectionOrders[i].quoteTitle == null ? injectionOrders[i].productName : injectionOrders[i].quoteTitle)+'</span>'+
			        					'</td>'+
...
//			        					'<td><a href="#" class="bj">Quotation</a></td>'+
			        				'</tr>';		
		    			  ...
		    			  if(trs_odd != ""){
		    				  table_odd =  '<table class="table1 pull-left">'+
								        			'<thead>'+
								        				'<tr>'+
								        					'<th class="th1"></th>'+
								        					'<th class="th2">Enquiry Information</th>'+
								        					'<th class="th2">Publish Date</th>'+
...
//								        					'<th class="th3"></th>'+
		    			  ...
		    			  var  table =  '<div class="inquiry_0 clearfix">'+
							          			'<div class="title">'+
							    				'<span><i class="iconfont">&#xe648;</i></span><em>Plastic</em>'+
		    		  ...
		    		  if(metalOrders != null && metalOrders != '' && metalOrders != undefined){
		    			  ...
		    			  for(var i=0;i<metalOrders.length;i++){
		    				  ...
		    				  var tr = '<tr>'+
			        						...
			        						'</div>'+
			        						'<span class="amt10" title="'+(metalOrders[i].quoteTitle == null ? metalOrders[i].productName : metalOrders[i].quoteTitle)+'" target="_blank">'+(metalOrders[i].quoteTitle == null ? metalOrders[i].productName : metalOrders[i].quoteTitle)+'</span>'+
			        					'</td>'+
...
//			        					'<td><a href="/en/detail.html?orderId='+metalOrders[i].orderId+'" class="bj">Quotation</a></td>'+
			        				'</tr>';		
...
//								        					'<th class="th3"></th>'+
		    			  ...
		    			  var  table =  '<div class="inquiry_0 clearfix">'+
							          			'<div class="title">'+
							    				'<span><i class="iconfont">&#xe648;</i></span><em>Casting</em>'+
		    		  ...
		    		  if(machiningOrders != null && machiningOrders != '' && machiningOrders != undefined){
		    			  ...
		    			  for(var i=0;i<machiningOrders.length;i++){
		    				  ...
		    				  var tr = '<tr>'+
			        						...
			        						'</div>'+
			        						'<span class="amt10" title="'+(machiningOrders[i].quoteTitle == null ? machiningOrders[i].productName : machiningOrders[i].quoteTitle)+'" target="_blank">'+(machiningOrders[i].quoteTitle == null ? machiningOrders[i].productName : machiningOrders[i].quoteTitle)+'</span>'+
			        					'</td>'+
...
//			        					'<td><a href="/en/detail.html?orderId='+machiningOrders[i].orderId+'" class="bj">Quotation</a></td>'+
			        				'</tr>';		
...
//								        					'<th class="th3"></th>'+
		    			  ...
		    			  var  table =  '<div class="inquiry_0 clearfix">'+
							          			'<div class="title">'+
							    				'<span><i class="iconfont">&#xe648;</i></span><em>Processing</em>'+
		    		  ...
		    		  if(machiningCastingOrders != null && machiningCastingOrders != '' && machiningCastingOrders != undefined){
		    			  ...
		    			  for(var i=0;i<machiningCastingOrders.length;i++){
		    				...
		    				//获取国家对标国旗
		    				  ...
		    				  '</div>'+
		    				  '<span class="amt10" title="'+(machiningCastingOrders[i].quoteTitle == null ? machiningCastingOrders[i].productName : machiningCastingOrders[i].quoteTitle)+'" target="_blank">'+(machiningCastingOrders[i].quoteTitle == null ? machiningCastingOrders[i].productName : machiningCastingOrders[i].quoteTitle)+'</span>'+
		    				  '</td>'+
...
//		    				  '<td><a href="/en/detail.html?orderId='+machiningCastingOrders[i].orderId+'" class="bj">Quotation</a></td>'+
		    				  '</tr>';		
...
//		    					  '<th class="th3"></th>'+
		    			  ...
		    			  var  table =  '<div class="inquiry_0 clearfix">'+
		    			  '<div class="title">'+
		    			  '<span><i class="iconfont">&#xe648;</i></span><em>Machining Process</em>'+
		    			  '</div>'+ table_odd2 + table_even2 +
		    			  '</div>';
		    		  ...
		    		  if(castingOrders != null && castingOrders != '' && castingOrders != undefined){
		    			  ...
		    			  for(var i=0;i<castingOrders.length;i++){
		    				  ...
		    				  var tr = '<tr>'+
			        						...
			        						'</div>'+
			        						'<span class="amt10" title="'+(castingOrders[i].quoteTitle == null ? castingOrders[i].productName : castingOrders[i].quoteTitle)+'" target="_blank">'+(castingOrders[i].quoteTitle == null ? castingOrders[i].productName : castingOrders[i].quoteTitle)+'</span>'+
			        					'</td>'+
...
//			        					'<td><a href="/en/detail.html?orderId='+castingOrders[i].orderId+'" class="bj">Quotation</a></td>'+
			        				'</tr>';		
...
//								        					'<th class="th3"></th>'+
		    			  ...
		    			  var  table =  '<div class="inquiry_0 clearfix">'+
							          			'<div class="title">'+
							    				'<span><i class="iconfont">&#xe648;</i></span><em>Forging</em>'+
		    		  ...
		    		  if(otherOrders != null && otherOrders != '' && otherOrders != undefined){
		    			  ...
		    			  for(var i=0;i<otherOrders.length;i++){
		    				  ...
		    				  '</div>'+
		    				  '<span class="amt10" title="'+(otherOrders[i].quoteTitle == null ? otherOrders[i].productName : otherOrders[i].quoteTitle)+'" target="_blank">'+(otherOrders[i].quoteTitle == null ? otherOrders[i].productName : otherOrders[i].quoteTitle)+'</span>'+
		    				  '</td>'+
...
//		    				  '<td><a href="/en/detail.html?orderId='+otherOrders[i].orderId+'" class="bj">Quotation</a></td>'+
		    				  '</tr>';		
...
//								        					'<th class="th3"></th>'+
		    			  ...
		    			  var  table =  '<div class="inquiry_0 clearfix">'+
						    			  '<div class="title">'+
						    			  '<span><i class="iconfont">&#xe648;</i></span><em>Other</em>'+
		      ...
		      if(result.state == 0){
		    	  ...
		    	  for(var i=0;i<tl;i++){	    
		    		  ...
		    		  var tr =   '<tr>'+
				                      ...
				                      '<div class="imgs2">'+
				                      '<img style="margin:0;" src="'+((inquiryOrders[i].drawingPathCompress == null ||  inquiryOrders[i].drawingPathCompress ==  '')? '../images/pic2.png' : inquiryOrders[i].drawingPathCompress)+'" alt="" class="img2"/><br/></div>'+
				                      '<span class="amt10" title="'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'" target="_blank">'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'</span>'+
				                  '</td>'+
				                  '<td class="d2">'+
				                      '<span>'+(inquiryOrders[i].mainProcess == null ? '' : inquiryOrders[i].mainProcess)+'</span><br/>'+
				                      '<span>'+(inquiryOrders[i].annualQuantity == null ? '' : inquiryOrders[i].annualQuantity)+'</span>'+
...
//		    	  compare();
 ...
 function queryDetails(orderId){
    top.location = "/en/detail.html?orderId="+orderId;
 }
