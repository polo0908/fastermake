			...
			function(result){
		      if(result.state == 0){
		    	  ...
		    	  for(var i=0;i<tl;i++){
		    		  ...
		    		  //判断收藏的产品是否已报价
		    		 var a = '';
		    		 if(inquiryOrders[i].quoteState == null || inquiryOrders[i].quoteState == '' || inquiryOrders[i].quoteState == undefined){
		    			a = '<a href="/inquiry/'+inquiryOrders[i].orderId+'" class="amt10" title="'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'" target="_blank">'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'</a>';
		    		 }else{
		    		  ...
		    		  var tr =   '<tr>'+
				                      ...
				                      '<div class="imgs2">'+
				                      '<img src="'+((inquiryOrders[i].drawingPathCompress == null || inquiryOrders[i].drawingPathCompress == '') ? '../images/pic2.png' : inquiryOrders[i].drawingPathCompress)+'" alt="" class="img2"/><br/></div>'+a+				                      				                      
				                      '</td>'+
				                  '<td class="d2">'+
