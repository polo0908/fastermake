             ...
             var flag=false;
      	        	   ...
      	        	   function(result){
      	        	     if(result.state == 0){
	     	                ...
	     	                e_judgment = true;
	      	      	    	 ...
	      	      	    	 $('#email').next().addClass('error');
	     			    	 $('#email').next().text("E-mail already exists").fadeIn();
	     			    	 e_judgment = false;
      	        	     }
      	        	  }); 
	             })     
	       	...
	       	$('#buyer_name').blur(function(){     
	       		...
	       		if(!(userName.trim() == '')){
	       			...
	       			$('#buyer_name').next().addClass('error').text("Contact name can not be empty").fadeIn();
	       			user_judgment = false; 
	       		}		       		 
	       		return false;
	       	});
	            ...
	            $('#buyer_email').blur(function(){
	             $('#buyer_email').next().css({"display":"none"});
	           	 ...
	           	 if(email == null || email == ''){
	           		 ...
	           		 $('#buyer_email').next().text("E-mail address can not be empty").fadeIn();
	           		 e_judgment = false;
	           		 return false;
	           	 }
	   	       	   //验证邮箱是否合法
      	        	   ...
      	        	   function(result){
      	        	     if(result.state == 0){
	     	                ...
	     	                e_judgment = true;
	      	      	    	 ...
	      	      	    	 $('#buyer_email').next().addClass('error');
	     			    	 $('#buyer_email').next().text("E-mail already exists").fadeIn();
	     			    	 e_judgment = false;
      	        	     }
      	        	  }); 
	             })         
	    	       	...
	    	       	$.ajax({
	    				...
	    				success : function(data) {
	    					...
	    					if(data.state==0){
    							...
    							if(lan == 'en'){
    								window.location = "/en/welcome.html";
    							}else{
    								window.location = "/zh/welcome.html";
    							}
	    					}
        		...
        		$.ajax({
    				...
    				success : function(data) {
    					...
    					if(data.state==0){
    						...
    						var lan = getCookie("language");
    						if(lan == 'en'){
    							redirectUrl = redirectUrl.replace('zh','en');
    						}
