...
function getProvince()
{
   ...
   var provincesobj=document.getElementById("select_province");
...
$('#province').val($('#select_province').find("option:selected").text());

}

function select_city(){
	var cityobj= $("#select_city").find("option:selected").text();
	$('#city').val(cityobj);
}
