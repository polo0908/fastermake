...
//                     }
		    		  ...
		    		  var tr =   '<tr>'+
				                      '<td>'+
				                      '<a href="/en/purchase_detail.html?orderId='+inquiryOrders[i].orderId+'" class="imgs">'+
				                      ...
				                      '</a>'+
				                  '</td>'+
				                  '<td><a href="/en/purchase_detail.html?orderId='+inquiryOrders[i].orderId+'" class="w100 color_006dcc fAM">'+inquiryOrders[i].orderId+(inquiryOrders[i].csgOrderId == null ? '' : '('+inquiryOrders[i].csgOrderId+')')+'</a></td>'+
